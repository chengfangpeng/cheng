package com.zhensan.client.util;
...
public class DeviceUtils {
	 ...
	 * 
	 * @param context
	 * @return 1.tm.CALL_STATE_IDLE = 0 无活�? 2.tm.CALL_STATE_RINGING = 1 响铃
	...
	/**
	 * 获取该设备中有效的CPU核数 �?要查看系统文件夹 "/sys/devices/system/cpu" 的权�?
	 * 
	 * @return 设备CPU核数
	 */

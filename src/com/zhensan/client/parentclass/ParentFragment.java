...
public abstract class ParentFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		manager = SlidingMenuControlActivity.activity
				.getSupportFragmentManager();
		if (savedInstanceState != null) {
			saveData = (Object[]) savedInstanceState
					.getSerializable(SaveDataKey);
			// System.out.println("---ParentFragment---savedInstanceState---" +
			// saveData[0]);
		}
		...
		if (bundle != null) {
			...
			// System.out.println("---ParentFragment---getArguments---" +
			// params[0]);
			if (params == null) {
...
//				break;
	...
	protected void onSaveInstanceState(Bundle outState,
		...
		// System.out.println("---ParentFragment---onSaveInstanceState---" +
...
//		return listView;
	...
	protected void switchFragment(ParentFragment fragment, String fragmentName,
			Object... params) {
		switchFragment(R.id.slidingmenu_control_FrameLayout, fragment,
				fragmentName, params);
	}
	...
	protected void switchFragment(int replaceLayout, ParentFragment fragment,
		...
		if (fragment != null) {
			if (params != null) {
				...
				Log.i(this.getClass().getSimpleName(), "目标ParentFragment未传递参�?");
			}
	...
	//hide方法隐藏fragment
	protected void switchFragmentHide(ParentFragment fragment, String fragmentName,
			Object... params) {
//		switchFragmentHide(R.id.slidingmenu_control_FrameLayout, fragment,
//				fragmentName, params);
	}
	protected void switchFragmentHide(int replaceLayout,
			ParentFragment fragment, String fragmentName, Object... params) {
		if (fragment != null) {
			if (params != null) {
				Bundle args = new Bundle();
				args.putSerializable(SlidingMenuControlActivity.KEY, params);
	...
	protected void switchFragmentNoBack(ParentFragment fragment,
			Object... params) {
//		switchFragmentNoBack(R.id.slidingmenu_control_FrameLayout, fragment,
//				params);
	}
